...
// ── Difficulty mapping based on mastery score ──────────────
...
function parseReinforcementJSON(raw) {
  ...
  // ── Strategy 1: find outermost [ ... ] array ────────────
  ...
  // ── Strategy 2: truncate at last valid } before ] ───────
  ...
  // ── Strategy 3: find { ... } wrapper with "questions" key ─
...
async function submitReinforcementAnswers(req, res, next) {
  try {
    ...
    // ── If topic is now mastered ➜ update StudentProfile ──
    if (isCompleted) {
