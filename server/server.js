...
const reinforceRoutes = require("./routes/reinforce.routes");
...
// ────────────────────────────────────────────────────────────
const { uploadMaterial } = require("./controllers/material.controller");
const {
  generateQuiz,
  regenerateQuiz,
...
// ── Start ────────────────────────────────────────────────────
const { warmUp, checkHealth } = require("./services/ollama.service");
