            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="px-5 py-2.5 rounded-xl border border-slate-200 font-semibold text-sm
                           flex items-center gap-2 hover:bg-slate-50 transition disabled:opacity-50"
              >
                {regenerating ? (
            ...
            {quizDetail.questions?.map((q, i) => (
              ...
              >
                <div className="flex items-start gap-3">
                  <span className="w-7 h-7 rounded-full bg-indigo-50 text-indigo-600 border border-indigo-100 flex items-center justify-center text-xs font-bold shrink-0 mt-0.5">
                    {i + 1}
                  </span>
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex gap-4">
        <div className="flex-1 relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-slate-200
                       bg-white text-sm outline-none focus:border-indigo-300
        ...
        <select
          ...
          className="px-4 py-2.5 rounded-xl border border-slate-200
                     bg-white text-sm outline-none cursor-pointer"
        >
          ...
          {filteredQuizzes.map((quiz) => (
            <div
              ...
              className="rounded-2xl border border-slate-200 bg-white
                         p-5 cursor-pointer hover:border-indigo-300 transition group shadow-sm"
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <div
                    className="w-10 h-10 rounded-xl bg-gradient-to-br from-indigo-500 to-cyan-500
      ...
      {loadingDetail && (
        <div className="fixed inset-0 bg-black/20 flex items-center justify-center z-50">
          <div className="rounded-2xl bg-white p-8 flex items-center gap-4 shadow-2xl">
