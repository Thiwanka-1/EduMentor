...
export default function AceFlashcards() {
  return (
    <div className="flex gap-6">
      {/* ================= LEFT AI ASSISTANT ================= */}
      <aside className="w-72 rounded-3xl border border-black/5 dark:border-white/10 bg-white dark:bg-[#070b18] p-5">
        ...
        {/* Upload */}
        <div
          className="rounded-xl border border-dashed border-black/10 dark:border-white/20
        ...
        <div className="mt-4 space-y-2">
          <button className="w-full py-2 rounded-xl bg-black/5 dark:bg-white/5 hover:bg-black/10 dark:hover:bg-white/10 text-sm">
            Paste Text
          </button>
      ...
      <main className="flex-1 space-y-6">
        ...
        <p className="text-sm text-slate-500">
          Home / Decks / <span className="text-slate-900 dark:text-white">New Deck</span>
        </p>
        ...
        <div className="flex justify-between items-center">
          <div className="space-y-2 flex-1">
            <div className="grid grid-cols-2 gap-4">
              <input
                className="rounded-xl bg-white dark:bg-[#070b18] border border-black/5 dark:border-white/10
                           px-4 py-2 text-sm"
          ...
          <button className="px-4 py-2 rounded-xl bg-slate-900 text-white dark:bg-white dark:text-black text-sm font-semibold">
            Save Deck
          </button>
        </div>
        ...
        <div className="space-y-4">
          <div className="flex justify-between items-center">
            <h3 className="font-semibold">
              Cards <span className="text-slate-500 dark:text-slate-400 text-sm">(12 Cards)</span>
            </h3>

            <div className="flex gap-2">
              <button className="px-3 py-1 rounded-lg bg-black/5 dark:bg-white/5 text-sm flex items-center gap-1">
                <Pencil size={14} /> Edit
              </button>
              <button className="px-3 py-1 rounded-lg bg-black/5 dark:bg-white/5 text-sm">
                Preview
              </button>
            </div>
          </div>
          ...
          <button
            className="w-full py-3 rounded-xl border border-dashed
                       border-black/10 dark:border-white/10 hover:border-indigo-500/40
  ...
  return (
    ...
    >
      <div className="p-4 border-r border-black/5 dark:border-white/10">
        <p className="text-xs text-slate-500 dark:text-slate-400 mb-1">TERM</p>
        <input
      ...
      <div className="p-4">
        <p className="text-xs text-slate-500 dark:text-slate-400 mb-1">DEFINITION</p>
        <textarea
