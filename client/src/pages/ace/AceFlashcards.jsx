...
export default function AceFlashcards() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      const suggested = result.cards.slice(0, 3).map((c) => c.term);
  ...
  if (view === VIEW.STUDY) {
    ...
    return (
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <h2 className="text-xl font-bold text-slate-900">{studyDeckName}</h2>
        <p className="text-sm text-slate-500">
          Card {studyIndex + 1} of {studyCards.length}
        </p>

        <div
          className="relative min-h-[280px] rounded-3xl border border-slate-200
        ...
        >
          {!flipped ? (
            <div className="text-center space-y-4">
              ...
              <p className="text-2xl font-bold text-slate-900">{card?.term}</p>
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-xs text-slate-500 mt-6">Click to see term</p>
            </div>
          )}
        </div>
        ...
        <div className="flex items-center justify-center gap-4">
          <button
            ...
            className="p-3 rounded-xl bg-slate-100 hover:bg-slate-200 transition disabled:opacity-30
        ...
        <aside className="w-72 shrink-0 rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
          ...
          <div
            className="rounded-xl border border-dashed border-slate-200
                       p-6 text-center hover:border-indigo-300 transition cursor-pointer"
          ...
          >
            ...
            {selectedFile && (
              <div className="mt-3 flex items-center gap-2 justify-center text-xs text-emerald-600">
                <FileText size={14} />
                {selectedFile.name}
              </div>
            )}
          ...
          <div className="mt-4 space-y-2">
            <button
              ...
              className="w-full py-2 rounded-xl bg-slate-100 hover:bg-slate-200 text-sm transition"
            >
            ...
            {showPasteBox && (
              <textarea
                ...
                className="w-full rounded-xl border border-slate-200
                           bg-slate-50 p-3 text-xs resize-none
          ...
          {suggestedTerms.length > 0 && (
            <div className="mt-6">
              ...
              {suggestedTerms.map((t) => (
                ...
                >
                  <p className="font-medium text-indigo-600">{t}</p>
          ...
          <div className="flex justify-between items-start">
            <div className="space-y-2 flex-1">
              <div className="grid grid-cols-2 gap-4">
                <input
                  className="rounded-xl bg-white border border-slate-200 px-4 py-2 text-sm focus:outline-none
            ...
            {cards.map((card, i) => (
              <div
                ...
                className="relative rounded-2xl border border-slate-200
                           bg-white grid grid-cols-2 overflow-hidden
                           group"
              >
            ...
            {editMode && (
              <button
                ...
                className="w-full py-3 rounded-xl border border-dashed border-slate-200
                           hover:border-indigo-300 text-sm
          ...
          {decks.map((deck) => (
            <div
              ...
              className="rounded-2xl border border-slate-200
                         ...
                         hover:shadow-lg hover:shadow-indigo-500/10 transition group"
            >
              ...
              <div className="flex gap-2 pt-1">
                ...
                <button
                  ...
                  className="flex-1 py-2 rounded-xl bg-slate-100
                             hover:bg-slate-200 text-xs font-medium
                ...
                <button
                  ...
                  className="py-2 px-3 rounded-xl bg-slate-100
